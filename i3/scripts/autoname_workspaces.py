...
WINDOW_ICONS = {
    ...
    'cura': fa.icons['cube'],
    'darktable': fa.icons['camera-retro'],
    'evince': fa.icons['book'],
    'feh': fa.icons['camera-retro'],
    'firefox': fa.icons['firefox'],
    'gimp': fa.icons['paint-brush'],
    'gimp-2.10': fa.icons['paint-brush'],
    'gpick': fa.icons['eye-dropper'],
    'google-chrome': fa.icons['chrome'],
    'gummi': fa.icons['font'],
    'chromium': fa.icons['chrome'],
    'kicad': fa.icons['microchip'],
    'libreoffice': fa.icons['highlighter'],
    'lxterminal': fa.icons['laptop'],
    'mail': fa.icons['envelope'],
    'mupdf': fa.icons['book'],
    'pcmanfm': fa.icons['folder-open'],
    'rstudio': fa.icons['chart-bar'],
    'signal': fa.icons['comment'],
    'spotify': fa.icons['music'],  # could also use the 'spotify' icon
    'steam': fa.icons['steam'],
    'sakura': fa.icons['laptop'],
    'subl': fa.icons['code'],
    'subl3': fa.icons['code'],
    'termite': fa.icons['laptop'],
    'thunar': fa.icons['folder-open'],
    'thunderbird': fa.icons['envelope'],
    'urxvt': fa.icons['laptop'],
    'xfce4-terminal': fa.icons['laptop'],
